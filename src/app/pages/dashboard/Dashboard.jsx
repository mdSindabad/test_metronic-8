        ...
        <div class="col-xxl-4">
          ...
          <div class="card card-xl-stretch mb-xl-8">
            ...
            <div class="card-body p-0">
              {/** <!--begin::Chart--> */}
              <div
                class="mixed-widget-12-chart card-rounded-bottom bg-primary"
            ...
            <div class="card-header border-0 pt-5">
              ...
              <div class="card-toolbar">
                <ul class="nav">
                  <li class="nav-item">
                    <a
                      class="nav-link btn btn-sm btn-color-muted btn-active btn-active-dark active fw-bolder px-4 me-1"
                      data-bs-toggle="tab"
